      ...
      <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
          <el-form :inline="true" :model="page">
            <el-form-item>
             <el-select size="small" v-model="page.warehouseLock" placeholder="所属仓库">
                <el-option
            ...
            <el-form-item>
              <el-select size="small" v-model="page.warehouseLock" placeholder="库位锁状态">
                <el-option
        ...
        >
          ...
          <el-table-column prop="location" label="库位编号"></el-table-column>
          <el-table-column prop="wid" label="所属仓库"></el-table-column>
          <el-table-column prop="description" label="库位描述"></el-table-column>
        ...
        <el-form :model="addData" class="demo-ruleForm">
         <el-row>
            <el-col :span="12">
              ...
              >
                <el-input v-model="addData.tempUpperLimit" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item
                ...
                :label-width="formLabelWidth"
              >
                <el-input v-model="addData.tempLowerLimit" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
           <el-row>
            <el-col :span="12">
              <el-form-item
                ...
                :label-width="formLabelWidth"
              >
                <el-input v-model="addData.humidityUpperLimit" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item
                ...
                :label-width="formLabelWidth"
              >
                <el-input v-model="addData.humidityLowerLimit" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
           <el-row>
            ...
            <el-col :span="12">
              <el-form-item
                ...
                :label-width="formLabelWidth"
              >
                <el-input v-model="addData.maximum" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
              <el-row>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item
                ...
                :label-width="formLabelWidth"
              >
                <el-input v-model="editData.tempUpperLimit" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item
                ...
                :label-width="formLabelWidth"
              >
                <el-input v-model="editData.tempLowerLimit" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
           <el-row>
            <el-col :span="12">
              <el-form-item
                ...
                :label-width="formLabelWidth"
              >
                <el-input v-model="editData.humidityUpperLimit" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item
                ...
                :label-width="formLabelWidth"
              >
                <el-input v-model="editData.humidityLowerLimit" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
           <el-row>
            ...
            <el-col :span="12">
              <el-form-item
                ...
                :label-width="formLabelWidth"
              >
                <el-input v-model="editData.maximum" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
              <el-row>
